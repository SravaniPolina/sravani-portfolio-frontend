      ...
      <div className="max-w-5xl mx-auto px-6">
        <div className="rounded-[36px] p-14 text-center" style={{background: "white", border: "1px solid rgba(13,59,46,0.15)"}}>
          ...
          <div className="flex flex-wrap justify-center gap-5 mb-16">
            <a href="https://topmate.io/sravani_polina" target="_blank" rel="noopener noreferrer" className="primary-btn" style={{borderColor: "var(--green)", color: "var(--green)"}}>Book a Strategy Call</a>
