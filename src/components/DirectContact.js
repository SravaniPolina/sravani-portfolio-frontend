    ...
    <section id="contact" className="py-28" style={{background: "var(--beige)"}}>
      <div className="max-w-5xl mx-auto px-6">
        <div className="rounded-[36px] p-14 text-center" style={{background: "white", border: "1px solid rgba(13,59,46,0.15)"}}>
          ...
          <h2 className="font-serif text-5xl mt-4 mb-6" style={{color: "var(--green)"}}>
            Let's build something meaningful.
          </h2>
          <p className="max-w-2xl mx-auto text-lg mb-12" style={{color: "#3A3A3A"}}>
          ...
          <div className="flex flex-wrap justify-center gap-5 mb-16">
            ...
            >
              ...
              style={{borderColor: "rgba(13,59,46,0.3)", color: "#3A3A3A"}}
            >
              Email Me
            </a>
          </div>
          <div className="grid md:grid-cols-3 gap-8 pt-10" style={{borderTop: "1px solid rgba(13,59,46,0.15)"}}>
            ...
            <div>
              <h4 className="mb-2 font-semibold" style={{color: "var(--gold)"}}>LinkedIn</h4>
                ...
                rel="noopener noreferrer"
                style={{color: "#3A3A3A"}}
                className="hover:text-[#0D3B2E] transition"
              >
