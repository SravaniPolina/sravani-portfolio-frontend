    ...
    <section id="services" className="bg-slate-50 py-16 px-4">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-white rounded-xl p-7 shadow flex flex-col items-start">
          ...
          <div className="bg-white rounded-xl p-7 shadow flex flex-col items-start md:col-span-2">
            <div className="text-4xl mb-4">🎓</div>
