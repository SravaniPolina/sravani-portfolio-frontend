    ...
    <nav className="w-full bg-white shadow sticky top-0 z-50">
      <div className="flex items-center justify-between py-5 px-4 sm:px-8">
        ...
        <div className="hidden sm:flex gap-6 text-base text-slate-700">
          ...
          <a href="#impact" className="hover:text-indigo-600">Impact Stories</a>
          <a href="#testimonials" className="hover:text-indigo-600">Testimonials</a>
          <a href="#contact" className="hover:text-indigo-600">Contact</a>
        </div>
        <a href="https://topmate.io/sravani_polina" target="_blank" rel="noopener noreferrer" className="hidden sm:block px-4 py-2 rounded bg-green-600 text-white font-bold hover:bg-greeb-700 transition">Book a Call</a>
      </div>
      {isOpen && (
        <div className="sm:hidden bg-white border-t border-gray-200 px-4 py-4 space-y-3">
          ...
          <a href="#impact" className="block text-slate-700 hover:text-indigo-600" onClick={() => setIsOpen(false)}>Impact Stories</a>
