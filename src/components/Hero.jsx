        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-4 lg:gap-5 mt-12 max-w-md">
                <div className="p-4 lg:p-6 rounded-2xl overflow-hidden" style={{background: "var(--beige)", border: "1px solid rgba(200,157,60,0.2)"}}>
                  <div className="gold-text font-serif text-2xl sm:text-3xl lg:text-4xl leading-tight">
                    ₹750M+
                  </div>
                  <div className="mt-2 text-xs lg:text-sm" style={{color: "#3A3A3A"}}>
          ...
          <div className="flex justify-end">
            <img
              ...
              alt="Sravani Polina, fractional CFO and strategy advisor based in Hyderabad"
